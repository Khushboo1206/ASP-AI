...
export default function Home() {
     ...
     <section className="w-full py-12 md:py-24 bg-muted/50">
        <div className="container mx-auto px-4 md:px-6">
         ...
         <div className="flex flex-col items-center justify-center space-y-2">
          ...
          <p className="text-muted-foreground">Scuess Rate</p>
         </div>
         <div className="flex flex-col items-center justify-center space-y-2">
  ...
  <CardContent className="pt-6 ">
    <div className="flex flex-col space-y-4">
      ...
      unoptimized
      className="rounded-full object-cover boarder-2 boarder-primary/20"
      />
      </div>
      <div>
    ...
    <AccordionContent>{faqs.answer}</AccordionContent>
      ...
      <div className="mx-auto py-24 gradient rounded-lg bg-gradient-to-b from-gray-400 via-gray-200 to-gray-600">
       <div className="flex flex-col items-center justify-center space-y-4 text-center max-w-3xl mx-auto">
        ...
        size="lg"
        varient="secondary"
        className="h-11 mt-5 animate-bounce  bg-zinc-900 text-white"
        >
